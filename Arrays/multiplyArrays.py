# Write a program that takes two arrays representing integers, and returns an integer array representing their product. For example, since 193707721x -761838257287 = -147573952589676412927
